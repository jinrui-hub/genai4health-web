  ...
  return (
    <footer className="bg-slate-950 py-12 text-center border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
        <div className="mb-6 font-bold text-2xl text-white tracking-tight">AI4Health Association</div>
        ...
        <div className="text-slate-600 text-xs">
          &copy; {new Date().getFullYear()} AI4Health Association. All rights reserved.
        </div>
      </div>
    </footer>
  );
